...
const LAPTOP_COLS = 'id,serial,name,location,category,conditionNote,chargerStatus,seller,status,priceRmb,shippingRmb,exchangeRate,importPriceVnd,wholesalePriceVnd,retailPriceVnd,customProfit,trackingCode,importDate,warehouseDate,is_active,batteryHealth,isLocked,screenStatus,cameraMicStatus,mainboardStatus,created_at,partsHistory';
// Alias cho select trong Supabase query (snake_case)
const LAPTOP_SELECT = 'id,serial,name,location,category,condition_note,charger_status,seller,status,price_rmb,shipping_rmb,exchange_rate,import_price_vnd,wholesale_price_vnd,retail_price_vnd,custom_profit,tracking_code,import_date,warehouse_date,is_active,battery_health,is_locked,screen_status,camera_mic_status,mainboard_status,created_at,parts_history';

const ORDER_SELECT = 'id,created_date,sale_online,note,order_type,order_status,payment_status,payment_method,delivery_status,shipping_method,laptop_id,sale_price,deposit_amount,deposit_note,cod_amount,amount_paid,debt_amount,credit_card_fee,profit_vnd,trade_in_laptop_id,customer_info,customer_address,tracking_code,ship_date,setup_note,warranty,gifts,laptop_locked,reservation_expires_at,cancel_reason,cancelled_at,is_active,created_at,updated_at';

...
const ORDER_SELECT = 'id,created_date,sale_online,sale_offline,note,order_type,order_status,payment_status,payment_method,delivery_status,shipping_method,laptop_id,requested_laptop_id,sale_price,deposit_amount,deposit_note,cod_amount,amount_paid,debt_amount,credit_card_fee,profit_vnd,trade_in_laptop_id,customer_id,customer_info,customer_address,tracking_code,ship_date,setup_note,warranty,gifts,branch_id,gift_preset,gift_accessory_ids,laptop_locked,reservation_expires_at,cancel_reason,cancelled_at,returned_at,return_reason,is_active,created_at,updated_at';

...
const query=await fetch(`${env.NEXT_PUBLIC_SUPABASE_URL}/rest/v1/user_profiles?name=like.TEST-AGING-*&is_active=eq.true&select=id,name,role`,{headers});const users=await query.json();
